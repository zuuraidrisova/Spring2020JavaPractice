...
public class Catalog {
    ...
    /**
     * write a method that gets an item name and returns all details for it. If item
    ...
    public ArrayList<String> getItemsLessThanAMonthlyPrice(double price) {
        ...
        for(int i = 0; i < monthlyPayments.size(); i++){
            ...
            if(monthlyPayments.get(i) <= price){
                ...
                ItemsLessThanAMonthlyPrice.add(items.get(i)+"-"+prices.get(i)+
...
class CatalogObject{
    ...
    public static void main(String[] args) {
        ...
        ctl2.deleteItemFromCatalog("Mouse");
