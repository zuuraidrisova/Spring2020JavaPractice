...
public class Encapsulation02_db {
    /*
    In  Db class we have two attributes/instance variables with the private
     visibility. meaning they cannot be accessed outside of the class.
...
Methods:
    - insertData - lets you set the values to above encapsulated instance
     variables.
