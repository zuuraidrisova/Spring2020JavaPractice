...
Note: studentID is composed of the student's first initial in uppercase followed
by the nextID
*/
    String name;
    int grade;
...
When the main constructor is called, it generates a student's ID by combining
 the student's first initial in uppercase combined with the next ID.  The nextID
  should then be increased by 1.
...
Write a static method called "newPrincipal" that returns nothing and takes in one
String parameters that represents the new principal's name.  Set the static variable
principalName to the new principal's name.
*/
