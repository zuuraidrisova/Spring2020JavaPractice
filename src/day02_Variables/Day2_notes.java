...
public class Day2_notes {
        ...
        System.out.println(): printing takes palce from new line.
            breaks the line
        System.out.print(): does not break the line, printing
            takes place from where its left off
        ...
        4. cannot contain special character
            other $ and _
        ...
        for numbers: byte, short, int, long, float, double
            ...
            byte
            larger one cannot be asisgned to
            smaller one
            smaller one can be assigned to larger
                    one
            int: prefered primitive by the compiler for whole numbers
            everytime if a number is entered, compiler
            takes it as an int
